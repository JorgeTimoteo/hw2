...
# TODO!
new_studio_1 = Studio.new
new_studio_1["name"] = "Warner Bros."
new_studio_1.save
...
new_movie_1["studio_id"] = warner_bros["id"]
new_movie_1.save
...
new_movie_2["studio_id"] = warner_bros["id"]
new_movie_2.save
...
new_movie_3["studio_id"] = warner_bros["id"]
new_movie_3.save
...
new_role_1 = Role.new
new_role_1["movie_id"] = batman_begins["id"]
new_role_1["actor_id"] = christian_bale["id"]
new_role_1["character_name"] = "Bruce Wayne"
new_role_1.save
...
for movie in movies
    ...
    puts Studio.find_by({studio["id"] => movie["studio_id"]})
end
